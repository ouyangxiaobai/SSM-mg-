...
<div class="container mg-t-b">
    ...
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        “蘑”幻世界始建于2019年，是廉政法院的政务网站，是廉政法院在互联网上唯一的正式身份。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        “蘑”幻世界是人民群众了解和联系国家最高审判机关的重要窗口，承载着法治宣传、服务群众、接受监督等重要使命。自从2010年2月25日进行第一次改版以来，“蘑”幻世界立足服务审判工作，积极推进司法信息公开，促进法院与公众互动交流。随着应用需求拓展和信息技术进步，为了更好地促进司法为民、公正司法，“蘑”幻世界进行了改版。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        “蘑”幻世界以崭新的面貌喜接新年。新版“蘑”幻世界是司法公开的综合平台，突出法院重点工作，页面简洁友好，方便网民访问查询，并融合了廉政法院官方微博、微信和新闻客户端。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        新版“蘑”幻世界服务版块清晰。在首页重要位置，展示了审判流程、裁判文书和执行信息三大公开平台，并推出廉政法院诉讼服务网，方便当事人咨询查询、预约立案、网上阅卷、联系法官。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
    ...
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        新版“蘑”幻世界信息发布以公开为原则、不公开为例外，力争权威迅速。新增“重大案件”栏目，给审判以指导，给犯罪分子以警醒，给网民以释法答疑。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        新年的钟声已经敲响。“全面推进依法治国，用法治保障人民权益、维护社会公平正义、促进国家发展”，这是习近平总书记在新年贺词中对全国人民提出的希望。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        “为将廉政法院建成世界上最透明的最高法院，将人民法院建成世界上最透明的法院而不懈努力”，这是廉政法院院长周强在“蘑”幻世界改版开通仪式上为我们设定的目标。
    </p>
    <p style="margin-top: 0px; margin-bottom: 10px; padding: 0px;">
        “蘑”幻世界改版是新的起点、新的契机，在新的一年里，欢迎你的监督，倾听你的呼声，满足你的期待。我们将在应用中不断改进和提高，逐步完善相关信息服务，进一步提升网站服务的针对性和实用性，努力让广大群众在方便快捷的司法信息服务中更加真切地感受司法文明和司法关怀。“蘑”幻世界将与微博、微信、新闻客户端共同发展，积极推进司法公开，满足人民群众的司法需求，提升司法公信力！
    </p>
