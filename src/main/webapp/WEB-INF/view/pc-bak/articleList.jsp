...
<div class="container mg-t-b">
    ...
    <div class="page-right">
        <div class="pagelujing">
            <div class="name">${type}列表</div>
            <span>您当前所在位置：<a href="#">首页</a> > <a href="#">${type}</a> > <a href="#">${type}</a></span></div>
        <div class="biaoti" style="border-bottom: 2px solid #eee;padding-bottom: 20px;">${type}</div>
